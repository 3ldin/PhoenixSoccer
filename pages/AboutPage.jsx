    ...
    <div>
      ...
      <div className='bg-gradient-to-b from-sky-600 to-blue-900 pb-10'>
        <div className='container mx-auto flex flex-col items-center text-center pt-4 mt-28'>
          <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-white mt-6 drop-shadow-xl'>About Us</h1>
          <h2 className='text-xl md:text-2xl lg:text-3xl mt-4 underline decoration-yellow-500'>We're The Best There Is!</h2>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 mt-8'>
          <div className='lg:col-span-2'>
            <h1 className=' lg:mt-16 lg:mb-20 text-3xl lg:text-5xl font-bold text-center drop-shadow-xl underline decoration-yellow-500'>Our Philosophy</h1>
      ...
      <h1 className='lg:col-span-4 mb-10 mx-auto text-3xl lg:text-5xl font-bold text-center drop-shadow-xl underline decoration-yellow-500'>Meet The Coaches</h1>
