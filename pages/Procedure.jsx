...
const Procedure = () => {
  ...
  return (
    <div>
      ...
      <Navbar />
      <SawyerWidget />
    <div className="mx-auto  text-center bg-gradient-to-b from-sky-600 to-blue-950">
      
      
      
      <h1 className="mb-4 pt-14 text-6xl md:text-4xl lg:text-5xl font-bold text-white drop-shadow-xl ">Procedures and Policies</h1>
